...
#canvas(length: 1pt, {
  ...
  for (left, tint, heading, subtitle, accent) in (
    ...
    label(left + 16, 194, 276, subtitle, size: 12pt, color: muted)
  }
  ...
  label(229, 239, 80, [empty], size: 12pt, color: blue)
  label(229, 296, 80, [filled], size: 12pt, color: blue)
  ...
  label(700, 298, 85, [photon], size: 11pt, color: orange)
  label(790, 318, 136, [electron + hole], size: 11pt, color: orange, centered: true)
  ...
  label(104, 710, 180, [orbital spacing], size: 14pt, color: blue, centered: true)
