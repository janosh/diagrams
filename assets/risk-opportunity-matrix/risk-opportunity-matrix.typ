...
#cetz.canvas(length: 1.3cm, {
  ...
  let attention-arrow = [The Arrow of Attention]
  ...
  labelled-arrow((width + 1, arrow-inset), (width + 1, height - arrow-inset), "probability2", probability, dir: rtl, align: top)

  labelled-arrow((arrow-inset, -1), (width/2 - arrow-inset, -1), "neg-impact", neg-impact, dir: ltr, align: bottom)
  labelled-arrow((width - arrow-inset, -1), (width/2 + arrow-inset, -1), "pos-impact", pos-impact, dir: rtl, align: bottom)
