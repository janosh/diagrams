...
\tikzset{
  % one arrowhead partway along a path, marking its orientation
  midarrow/.style={postaction={decorate}, decoration={markings,
        mark=at position #1 with {\arrow{latex}}}},
  midarrow/.default=.5,
  midarrowrev/.style={postaction={decorate}, decoration={markings,
        mark=at position #1 with {\arrowreversed{latex}}}},
  midarrowrev/.default=.5,
}
...
\begin{tikzpicture}
  ...
  \begin{scope}[xshift=9.5cm,yshift=1cm]
    ...
    \draw[midarrow]
    (0,-.25) -- ++(2,0);
    \draw[midarrow] (0,-.25) to[out=-120,in=0] (-.35,-.75) to[out=180,in=180] (-.35,.75) to[out=0,in=120] (0,.25);
    \draw (2,.25) to[out=120,in=0] (1.65,.75) -- (-.35,.75) (-.35,-.75) -- (1.65,-.75) to[out=0,in=-120] (2,-.25);
    \begin{scope}
      \clip (0,.25) rectangle (2,-.25);
      \draw[midarrowrev] (1.65,.75) to[out=180,in=180] (1.65,-.75);
    \end{scope}
  \end{scope}
  ...
  \begin{scope}[xshift=14.7cm,yshift=1cm]
    ...
    \draw[midarrow] (0,0) arc[start angle=0,delta angle=-360,x radius=.35,y radius=.75];
  ...
  \begin{scope}[xshift=4cm,yshift=-1.2cm]
    \draw[midarrow] (0,0) -- (3,0);
    \draw[midarrow=.6] (0,0) arc[start angle=0,delta angle=-360,x radius=.15,y radius=.35];
  ...
  \begin{scope}[xshift=9cm,yshift=-1.7cm]
    \draw[midarrow] (1,0) arc[start angle=0,delta angle=-360,x radius=.15,y radius=.35];
    ...
    \draw[midarrow] (a) ++(-.15,.35) arc[start angle=0,delta angle=-360,x radius=-.15,y radius=.35];
    ...
    \begin{scope}
      ...
      \draw[midarrow] (1,0) ++(-.15,-.35) ++(0,-.8) .. controls +(170:1) and +(-90:.5) .. ++(-1.5,.8) .. controls +(90:.5) and +(180:1.2) .. ++(2,1.5) .. controls +(0:1.2) and +(90:.5) .. ++(2,-1.5) .. controls +(-90:.5) and +(10:1) .. ++(-1.5,-.8);
    \end{scope}
    \begin{scope}
  ...
  \begin{scope}[xshift=14cm,yshift=-1.7cm]
    \draw[midarrowrev] (1.5,.35) arc[start angle=90,end angle=-90,y radius=.35,x radius=.1];
    ...
    \begin{scope}
      ...
      \draw[midarrow] (1.5,-.35) ++(0,-.6) .. controls +(180:1) and +(-90:.65) .. ++(-1.5,1) .. controls +(90:.65) and +(180:1) .. ++(1.5,1) .. controls +(0:1) and +(90:.65) .. ++(1.5,-1) .. controls +(-90:.65) and +(0:1) .. ++(-1.5,-1);
    \end{scope}
  \end{scope}
